...
Constants->>
*/
defined('THEME_NAME') or define('THEME_NAME', 'eltracom');
...
if( !function_exists('cbv_theme_setup') ){
	...
	function cbv_theme_setup(){
	    ...
	    load_theme_textdomain( 'eltracom', get_template_directory() . '/languages' );
...
function cbv_theme_scripts(){
	...
	include_once( THEME_DIR . '/enq-scripts/counter.php' );
