...
<div class="psolid-boards-con-ctrl">
<?php 
...
?>
  <section class="ec-product-details-sec-wrp sb-product-sec clearfix">
    ...
    <div class="ec-product-details-left clearfix matchHeightCol">
      <div class="ec-product-details-dsc az-solidboard">
...
<section class="ftr-top-wrp text-center text-center mt--65">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
