     ...
     <div class="cb-two-grid-controller clearfix">
       ...
       <div class="cb-two-grid-dsc-rgt-con clearfix matchHeightCol">
         <div class="cb-two-grid-dsc-rgt">
           <?php 
           if( !empty( $rcb['title'] ) ) printf( '<h6>%s</h6>', $rcb['title']);
           if( !empty( $rcb['content'] ) ) echo wpautop($rcb['content']);
           ?>
        </div>
       </div>
    </div>
